...
const Cog = createLucideIcon("cog", __iconNode$5);
/**
 * @license lucide-react v0.563.0 - ISC
 *
 * This source code is licensed under the ISC license.
    ...
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center space-x-2 cursor-pointer", onClick: () => window.scrollTo({ top: 0, behavior: "smooth" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex space-x-8", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.href,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setMobileMenuOpen(!mobileMenuOpen), className: "text-slate-800", children: mobileMenuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 24 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 24 }) }) })
        ] }),
        mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-xl border-t border-slate-100 p-6 flex flex-col space-y-4 shadow-lg", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
...
const Hero = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "hero", className: "relative w-full h-screen flex flex-col items-center justify-center overflow-hidden bg-[#F5F5F3]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
        ...
        width: "100%",
        height: "100%",
        className: "w-full h-[140%] -translate-y-[10%]",
        title: "Spline 3D Animation"
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 text-center max-w-4xl px-6 pointer-events-none h-full flex flex-col justify-end pb-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { size: 24, strokeWidth: 1.5 })
      }
    )
  ] });
};
const Tech = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "tech", className: "py-24 bg-white relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "order-2 md:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-light text-slate-800 mb-6", children: [
            "Custom Botanical ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Solutions" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 leading-relaxed mb-8 font-light", children: "Tailored extracts and specialized waters, engineered to bring your unique cosmetic visions to life, ensuring purity, potency and perfect compatibility." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: features.map(({ Icon: Icon2, title, desc }, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-slate-50 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-6 h-6 text-slate-700", strokeWidth: 1.5 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-slate-800", children: title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-500 font-light mt-1", children: desc })
            ] })
          ] }, idx)) })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 md:order-2 relative h-[500px] w-full flex items-center justify-center bg-slate-50 rounded-3xl overflow-hidden shadow-inner", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-slate-50 to-white z-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full h-full flex items-center justify-center p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.img,
        {
...
const VisualStream = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "w-full h-[60vh] relative bg-slate-900 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-10 bg-transparent" })
  ] });
};
const Products = () => {
  ...
  const [categories, setCategories] = reactExports.useState(["All"]);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "products", className: "py-24 bg-[#F5F5F3] min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-light text-slate-800 mb-4", children: "Smart Data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-500 font-light max-w-xl mx-auto", children: "Explore our curated library of high-performance ingredients." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-3 mb-12", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setActiveCategory(cat),
        className: `px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 border ${activeCategory === cat ? "bg-slate-800 text-white border-slate-800 shadow-md transform scale-105" : "bg-white text-slate-500 border-slate-200 hover:border-slate-400 hover:text-slate-700"}`,
        children: cat
      },
      cat
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: filteredProducts.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            layout: true,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-24 h-24 bg-slate-50 rounded-bl-full -mr-4 -mt-4 opacity-50 group-hover:scale-150 transition-transform duration-500 ease-out" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-3 py-1 rounded-full bg-slate-100 text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-4", children: product.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-medium text-slate-800 mb-2 group-hover:text-teal-700 transition-colors", children: product.item }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400 line-clamp-2 mb-4 font-light", children: product.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center text-xs text-slate-500 font-semibold mt-auto pt-4 border-t border-slate-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center group-hover:translate-x-1 transition-transform", children: [
                  "View Spec ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-50 p-6 border-b border-slate-100 flex justify-between items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-teal-600 uppercase tracking-widest", children: selectedProduct.brand || "KPROS" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-semibold text-slate-800 mt-1", children: selectedProduct.item })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 space-y-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "flex items-center text-sm font-semibold text-slate-400 uppercase tracking-wide mb-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Info, { size: 14, className: "mr-2" }),
                  " Description"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-600 font-light leading-relaxed", children: selectedProduct.description })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-50 p-4 rounded-xl border border-slate-100", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-bold text-slate-400 uppercase tracking-wide mb-2", children: "INCI Name" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-slate-800 font-mono", children: selectedProduct.inciName })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 flex space-x-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "flex-1 py-3 bg-slate-800 text-white rounded-xl text-sm font-medium hover:bg-slate-900 transition-colors", children: "Request Sample" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "flex-1 py-3 border border-slate-200 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors", children: "Download TDS" })
              ] })
            ] })
          ]
        }
...
const Contact = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "relative pt-24 pb-12 bg-slate-900 overflow-hidden min-h-screen flex flex-col justify-end", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-0 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "iframe",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-full px-6 flex flex-col items-center text-center pointer-events-none h-full flex-1 justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-7xl pointer-events-auto mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          whileHover: { y: -5 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base font-bold text-slate-400 uppercase tracking-widest mb-3", children: "Office" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl text-white font-semibold tracking-tight leading-relaxed", children: "GIDC Building A #2602, 43 Iljik-ro, Gwangmyeong-si, Gyeonggi-do, Republic of Korea" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "p-10 bg-white/5 backdrop-blur-md rounded-3xl shadow-lg border border-white/10 hover:bg-white/10 transition-all duration-300 flex flex-col justify-center",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-base font-bold text-slate-400 uppercase tracking-widest mb-3", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:kpros@kpros.co.kr", className: "text-2xl md:text-3xl text-white font-semibold hover:text-teal-400 transition-colors tracking-tight break-all", children: "kpros@kpros.co.kr" })
          ]
        }
      )
    ] }) }) })
...
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-slate-900 py-12 text-slate-400 text-sm font-light", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 md:mb-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold tracking-wider text-lg", children: "KPROS CORP" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-slate-500", children: "Digital Purity & Raw Perfection" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 md:mt-0 text-slate-600", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " KPROS CORP. All rights reserved."
    ] })
  ] }) });
};
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "antialiased text-slate-800 bg-[#F5F5F3]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tech, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(VisualStream, {}),
